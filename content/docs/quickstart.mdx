...
Copy `VapiBlocks/.env.example` to `.env`. The starter already includes sample Vapi public key and assistant ID values.
```bash
NEXT_PUBLIC_VAPI_PUBLIC_KEY="a7d92520-7adf-40e2-afa3-5a18323c281a"
NEXT_PUBLIC_VAPI_ASSISTANT_ID="802a785e-9d2b-44c5-91ff-71feac2063ba"
NEXT_PUBLIC_VAPI_CODER="802a785e-9d2b-44c5-91ff-71feac2063ba"
NEXT_PUBLIC_VAPI_SCHEDULER="802a785e-9d2b-44c5-91ff-71feac2063ba"
```
